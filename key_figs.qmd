...
for(i in 2:length(emergence_curves)){
  plot = plot +  geom_line(data = emergence_curves[[i]], aes(x = R0, y = P.Emergence, group = m, col = m, linetype = as.factor(mu)))  #plot p emergence as function of R0_1 for each m
}
