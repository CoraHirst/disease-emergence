...
ms = c(2, 4, 6, 8) #how many types? m-1 mutations required, meaning m-2 intermediate types
...
# plot
plot = ggplot() + 
  geom_line(data = probs.emergence, aes(x = R0, y = P.Emergence, group = m), col = "chite") + #plot p emergence as function of R0_1 for each m
