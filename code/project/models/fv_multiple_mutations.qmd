...
ggplot() + 
  ...
  scale_y_continuous(trans = "log10", limits = c(10^-8, 1)) + scale_x_continuous(limits = c(0,1)) +
...
ms = 3 #0:4 in paper; number of types here, number of intermediates in paper
...
ggplot() + 
  ...
  theme_bw() +
  labs(x = "R0 of introduced pathogen", y = "Probability of emergence") +
  scale_y_continuous(trans = "log10", limits = c(10^-8, 1)) +
  scale_color_manual(values = my.colors)
